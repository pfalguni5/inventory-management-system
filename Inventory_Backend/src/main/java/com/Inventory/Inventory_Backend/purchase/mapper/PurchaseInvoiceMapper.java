...
public class PurchaseInvoiceMapper {
        ...
        public PurchaseInvoiceItem toItemEntity(PurchaseInvoiceItemDTO dto) {
                ...
                BigDecimal baseAfterDiscount = base.subtract(discount)
                                .setScale(2, RoundingMode.HALF_UP);

                BigDecimal tax = baseAfterDiscount.multiply(gstRate)
                                .divide(BigDecimal.valueOf(100), 2, RoundingMode.HALF_UP);

                BigDecimal total = baseAfterDiscount.add(tax);
        ...
        public PurchaseInvoiceResponseDTO toResponseDTO(PurchaseInvoice entity) {
                ...
                List<PurchaseInvoiceItemResponseDTO> items = entity.getItems() == null
        ...
        public PurchaseInvoiceItemResponseDTO toItemResponseDTO(PurchaseInvoiceItem entity) {
                ...
                BigDecimal discount = entity.getDiscount() != null
                                ? entity.getDiscount()
                                : BigDecimal.ZERO;
